  ...
  return (
    <section className="w-auto h-full text-white" style={{
      ...
      <div className='flex flex-col lg:flex-row'>
        <div className='lg:w-3/5 lg:h-fit px-10 bg-gray-300/60 shadow-lg ml-4 mr-4 mt-2 drop-shadow-2xl'>
          <img
          ...
          <div className="text-center pb-1" onClick={toggleModal}>
            <button className="text-black/60 font-bold py-1 px-4 mt-1 rounded hover:underline">
              Read More
        ...
        <div className='lg:w-3/5 lg:h-fit px-10 bg-gray-300/60 shadow-lg ml-4 mr-4 mt-2 drop-shadow-2xl'>
          <h2 className="text-2xl text-center lg:text-left font-bold mb-1">&nbsp; Hobbies & Other Skills</h2>
        </div>
        ...
        <div>
  <h2 className="text-2xl items-center text-center justify lg:text-center font-bold mb-2 ml-2 mt-3">Academic Background</h2>
</div>
<div className="px-16 items-center mx-auto">
  <br />
  <Timeline horizontal>
    <Timeline.Item>
